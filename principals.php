...
$query = "SELECT id, name, gmail, campus, status FROM users WHERE role = 'Principal'";
...
<head>
    ...
    <title>Principals - Rehan School</title>
                    ...
                    <tbody>
                        <?php foreach ($principals as $principal): ?>
                            <tr>
                                ...
                                <td><?php echo $principal['gmail']; ?></td>
                                <td><?php echo $principal['campus']; ?></td>
                                <td><?php echo $principal['status']; ?></td>
                                <td><a href="principal_details.php?id=<?php echo $principal['id']; ?>" class="details-button">View Details</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
