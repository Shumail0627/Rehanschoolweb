...
// Check if the user is logged in and is a Vice-Principal
if (!isset($_SESSION['admin_id']) || $_SESSION['role'] != 'Vice-Principal') {
    header('Location: login.php');
    exit();
}

// Fetch the campus associated with the logged-in Vice-Principal
$campus = $_SESSION['campus'];

// Fetch students who belong to the same campus as the logged-in Vice-Principal
...
<head>
    ...
    <title>Vice-Principal Students - Rehan School</title>
...
<body>
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="vice_principal_students.php" class="active">Students</a></li>
