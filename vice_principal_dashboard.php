...
// Fetch assignments for the vice principal's campus
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_assignment'])) {
    ...
    header('Location: vice_principal_assignments.php');
    exit();
}
...
$viceprincipalsQuery = "SELECT COUNT(*) as count FROM users WHERE role = 'Vice-Principal' AND campus = '$campus'";
...
$viceprincipalsResult = mysqli_query($conn, $viceprincipalsQuery);
$teachersResult = mysqli_query($conn, $teachersQuery);
$studentsResult = mysqli_query($conn, $studentsQuery);

$principalsData = mysqli_fetch_assoc($principalsResult)['count'];
$viceprincipalsData = mysqli_fetch_assoc($viceprincipalsResult)['count'];
...
<head>
    ...
    <title>Vice-Principal Dashboard - Rehan School</title>
...
<div class="sidebar">
    ...
    <ul class="sidebar-menu">
        <li><a href="vice_principal_dashboard.php" class="active">Dashboard</a></li>
        <li><a href="vice_principal_students.php">Students</a></li>
        <li><a href="attendance.php">Attendance</a></li>
        <li><a href="vice_principal_assignments.php">Assignments</a></li>
...
<div class="content">
    <div class="dashboard-container">
        <h1>Vice-Principal Dashboard</h1>
        <p>Welcome, <?php echo $_SESSION['admin_name']; ?>!</p>
        <p class="campus-info"><?php echo $campus; ?> Campus</p>
        ...
        <div class="summary-cards">
            ...
            <div class="card">
                <h3>Total Vice-Principals</h3>
                <p><?php echo $viceprincipalsData; ?></p>
            </div>
            <div class="card">
