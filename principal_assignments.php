...
// Fetch students for the principal's campus
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_assignment'])) {
    ...
    header("Location: principal_assignments.php?student_id=$selected_student");
    exit();
}
...
<head>
    ...
    <style>
        /* Copy the styles from principal_dashboard.php and add/modify as needed */
        body {
...
<body>
    <div class="sidebar">
        <!-- Copy sidebar content from principal_dashboard.php -->
        <div class="sidebar">
    <h2># Rehan School</h2>
    <div class="user-info">
            ...
            <div class="student-list">
                <?php while ($student = mysqli_fetch_assoc($students_result)) : ?>
                    <div class="student-card" 
                        onclick="window.location.href='student_assignments.php?student_id=<?php echo $student['id']; ?>'">
